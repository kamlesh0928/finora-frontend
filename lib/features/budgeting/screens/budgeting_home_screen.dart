...
class BudgetingHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final budgetAmount = budgetCategoriesByRole.containsKey(role)
        ? budgetCategoriesByRole[role]!.fold<double>(
            0,
            (s, c) => s + c.recommended,
          )
        : 15000.0;
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Learn to allocate money wisely through interactive challenges.',
              ...
              GestureDetector(
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => BudgetAllocationScreen(role: role),
                  ),
                ),
                child: Container(
                  padding: const EdgeInsets.all(20),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                              'Allocate ${Formatters.currency(budgetAmount)} wisely this month!',
                              style: theme.textTheme.bodyMedium?.copyWith(
              ...
              Text(
                'Make decisions that affect your wallet',
