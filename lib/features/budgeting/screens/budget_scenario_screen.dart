...
class _BudgetScenarioScreenState extends State<BudgetScenarioScreen> {
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      'Wallet: ${Formatters.currency(wallet.balance)}',
                          ...
                          Wrap(
                            ...
                            children: [
                              if (d.walletImpact != 0)
                                _impactChip(
                                  d.walletImpact > 0
                                      ? '+${Formatters.currency(d.walletImpact)}'
                                      : Formatters.currency(d.walletImpact),
                                  d.walletImpact > 0
                                      ? const Color(0xFF43A047)
                              ...
                              if (d.stressImpact != 0)
                                _impactChip(
                                  d.stressImpact > 0
                                      ? '+${(d.stressImpact * 100).toInt()}% stress'
                                      : '${(d.stressImpact * 100).toInt()}% stress',
                                  d.stressImpact > 0
                                      ? const Color(0xFFF57C00)
                                      : const Color(0xFF43A047),
  ...
  void _makeDecision(BuildContext context, BudgetDecision decision) {
    ...
    if (decision.walletImpact > 0) {
      wallet.credit(
        amount: decision.walletImpact,
        category: 'budgeting',
        description: '${widget.scenario.title}: ${decision.title}',
        sourceModule: 'smart_budgeting',
      );
    } else if (decision.walletImpact < 0) {
      wallet.debit(
        amount: decision.walletImpact.abs(),
        category: 'budgeting',
        description: '${widget.scenario.title}: ${decision.title}',
        sourceModule: 'smart_budgeting',
      );
