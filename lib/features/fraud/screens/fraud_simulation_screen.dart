  ...
  void _makeDecision(bool? saidScam) {
    ...
    if (correct) {
      ...
      wallet.credit(
        amount: 200,
        category: 'reward',
        description: 'Fraud Prevention: Correctly identified "${sim.title}"',
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'This message was ${sim.isScam ? "a SCAM" : "LEGITIMATE"}',
                        style: theme.textTheme.titleSmall?.copyWith(
                          color: sim.isScam
                              ? const Color(0xFFD32F2F)
                              : const Color(0xFF43A047),
                      ...
                      if (isCorrect == true) ...[
                        ...
                        Container(
                          ...
                          child: Text(
                            'Earned ${Formatters.currency(200)} reward for correct identification!',
                      ...
                      if (isCorrect != true &&
                        ...
                        Container(
                          ...
                          child: Text(
                            '💸 Lost ${Formatters.currency(sim.walletImpactIfFooled.abs())} from wallet!',
                            style: const TextStyle(
                              fontWeight: FontWeight.bold,
